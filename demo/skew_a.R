...
# Average Skewness: 0.0
# Mixing proportions [equal]: 0.5 and 0.5
#####################################################

# Simulate a mixture model with specified characteristics
set.seed(1)
A <- MixSim.skew(BarGamma = 0.0, BarOmega = 0.05, K = 2, p = 2)

# Construct a contour plot for the simulated mixture   
contour2d(A, method = "skew", mar = c(1, 1, 1, 1), xlim = c(-0.1, 1.05), ylim = c(-0.2, 1.5), nlevels = 50, lwd = 1.5, xaxt = "n", yaxt = "n")
